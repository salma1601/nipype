...
class Refit(AFNICommandBase):
    ...
    >>> refit_2.inputs.atrfloat = ('IJK_TO_DICOM_REAL',
                                 '\'1 0.2 0 0 -0.2 1 0 0 0 0 1 0\'')
    ...
    >>> refit_3.inputs.in_file = 'NeedsLabels+tlrc'
    >>> refit_3.inputs.atrcopy = ('WithLabels+tlrc', 'BRICK_LABS')
    >>> refit_3.cmdline  # doctest: +ALLOW_UNICODE
    '3drefit -saveatr -atrcopy WithLabels+tlrc BRICK_LABS NeedsLabels+tlrc'
    >>> res = refit_3.run()  # doctest: +SKIP
    """
    _cmd = '3drefit'
